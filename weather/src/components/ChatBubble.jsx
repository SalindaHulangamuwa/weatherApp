...
export default function ChatBubble() {
  ...
  return (
    <div className="fixed bottom-6 left-6 md:left-auto md:right-6 z-50">
      <button
        onClick={toggleChat}
        className="bg-black/90 backdrop-blur-sm text-white rounded-full p-4 shadow-lg hover:bg-black/80 focus:outline-none focus:ring-2 focus:ring-gray-500/50 focus:ring-offset-2"
      >
        {isOpen ? (
          <svg
